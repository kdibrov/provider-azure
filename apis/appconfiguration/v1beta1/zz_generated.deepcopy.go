...
func (in *FeatureParameters) DeepCopyInto(out *FeatureParameters) {
	*out = *in
	...
	if in.ConfigurationStoreIDRef != nil {
		in, out := &in.ConfigurationStoreIDRef, &out.ConfigurationStoreIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.ConfigurationStoreIDSelector != nil {
		in, out := &in.ConfigurationStoreIDSelector, &out.ConfigurationStoreIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
...
func (in *KeyParameters) DeepCopyInto(out *KeyParameters) {
	*out = *in
	...
	if in.VaultKeyReferenceRef != nil {
		in, out := &in.VaultKeyReferenceRef, &out.VaultKeyReferenceRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.VaultKeyReferenceSelector != nil {
		in, out := &in.VaultKeyReferenceSelector, &out.VaultKeyReferenceSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
}
