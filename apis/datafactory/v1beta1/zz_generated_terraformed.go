...
// GetTerraformResourceType returns Terraform resource type for this FlowletDataFlow
func (mg *FlowletDataFlow) GetTerraformResourceType() string {
	return "azurerm_data_factory_flowlet_data_flow"
}

// GetConnectionDetailsMapping for this FlowletDataFlow
func (tr *FlowletDataFlow) GetConnectionDetailsMapping() map[string]string {
	return nil
}

// GetObservation of this FlowletDataFlow
func (tr *FlowletDataFlow) GetObservation() (map[string]any, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
// SetObservation for this FlowletDataFlow
func (tr *FlowletDataFlow) SetObservation(obs map[string]any) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
// GetID returns ID of underlying Terraform resource of this FlowletDataFlow
func (tr *FlowletDataFlow) GetID() string {
	if tr.Status.AtProvider.ID == nil {
		return ""
	}
	return *tr.Status.AtProvider.ID
...
// GetParameters of this FlowletDataFlow
func (tr *FlowletDataFlow) GetParameters() (map[string]any, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
// SetParameters for this FlowletDataFlow
func (tr *FlowletDataFlow) SetParameters(params map[string]any) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this FlowletDataFlow using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FlowletDataFlow) LateInitialize(attrs []byte) (bool, error) {
	params := &FlowletDataFlowParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
// GetTerraformSchemaVersion returns the associated Terraform schema version
func (tr *FlowletDataFlow) GetTerraformSchemaVersion() int {
	return 0
}
