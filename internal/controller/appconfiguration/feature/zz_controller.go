...
import (
	...
	v1beta1 "github.com/upbound/provider-azure/apis/appconfiguration/v1beta1"
)

// Setup adds a controller that reconciles Feature managed resources.
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	name := managed.ControllerName(v1beta1.Feature_GroupVersionKind.String())
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), o.WorkspaceStore, o.SetupFn, o.Provider.Resources["azurerm_app_configuration_feature"],
